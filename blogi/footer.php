				...
				<div class="col-md-12">
					<div class="site-info">
						...
						<?php if ( get_theme_mod( 'footer_love', 1 ) ) : ?>
							<span class="sep"> | </span>
							<?php
								/* translators: 1: Theme name, 2: Developer Site URL a tag. */
								printf( esc_html__( 'Theme: %1$s by %2$s.', 'blogi' ), 'Blogi', '<a href="https://www.cantothemes.com/" rel="designer">CantoThemes</a>' );
							?>
						<?php endif; ?>
					</div><!-- .site-info -->
				</div>
